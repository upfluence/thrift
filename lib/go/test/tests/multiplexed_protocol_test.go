...
//
// func (f *FirstImpl) ReturnOne(thrift.Context) (r int64, err error) {
// 	return 1, nil
// }
//
// type SecondImpl struct{}
//
// func (s *SecondImpl) ReturnTwo(thrift.Context) (r int64, err error) {
// 	return 2, nil
// }
//
...
//
// 	firstProcessor := multiplexedprotocoltest.NewFirstProcessor(&FirstImpl{}, nil)
// 	processor.RegisterProcessor("FirstService", firstProcessor)
//
// 	secondProcessor := multiplexedprotocoltest.NewSecondProcessor(&SecondImpl{}, nil)
...
// 	firstClient = multiplexedprotocoltest.NewFirstClient(thrift.NewTSyncClient(transport, protocol))
// 	err := transport.Open()
// 	if err != nil {
...
// 	secondClient = multiplexedprotocoltest.NewSecondClientClient(thrift.NewTSyncClient(transport, protocol))
// 	err := transport.Open()
// 	if err != nil {
// 		t.Fatal("Unable to open client socket", err)
// 	}
...
// 	ret, err := legacyClient.ReturnTwo(context.Background())
// 	//expect error since default processor is not registered
// 	if err == nil {
// 		t.Fatal("Expecting error")
// 	}
// 	//register default processor and call again
// 	processor.RegisterDefault(multiplexedprotocoltest.NewSecondProcessor(&SecondImpl{}, nil))
// 	legacyClient = createLegacyClient(t)
// 	ret, err = legacyClient.ReturnTwo(context.Background())
// 	if err != nil {
