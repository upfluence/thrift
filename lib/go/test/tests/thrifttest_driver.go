...
func (p *ThriftTestDriver) Start() {
	...
	if client.TestVoid(context.Background()) != nil {
		t.Fatal("TestVoid failed")
	}

	if r, err := client.TestString(context.Background(), "Test"); r != "Test" || err != nil {
		t.Fatal("TestString with simple text failed")
	}

	if r, err := client.TestString(context.Background(), ""); r != "" || err != nil {
	...
	if r, err := client.TestString(context.Background(), stringTest); r != stringTest || err != nil {
	...
	if r, err := client.TestString(context.Background(), specialCharacters); r != specialCharacters || err != nil {
		t.Fatal("TestString with specialCharacters failed")
	}

	if r, err := client.TestByte(context.Background(), 1); r != 1 || err != nil {
		t.Fatal("TestByte(1) failed")
	}
	if r, err := client.TestByte(context.Background(), 0); r != 0 || err != nil {
		t.Fatal("TestByte(0) failed")
	}
	if r, err := client.TestByte(context.Background(), -1); r != -1 || err != nil {
		t.Fatal("TestByte(-1) failed")
	}
	if r, err := client.TestByte(context.Background(), -127); r != -127 || err != nil {
		t.Fatal("TestByte(-127) failed")
	}

	if r, err := client.TestI32(context.Background(), -1); r != -1 || err != nil {
	...
	if r, err := client.TestI64(context.Background(), -5); r != -5 || err != nil {
		t.Fatal("TestI64(-5) failed")
	}
	if r, err := client.TestI64(context.Background(), 5); r != 5 || err != nil {
		t.Fatal("TestI64(5) failed")
	}
	if r, err := client.TestI64(context.Background(), -34359738368); r != -34359738368 || err != nil {
		t.Fatal("TestI64(-34359738368) failed")
	}

	if r, err := client.TestDouble(context.Background(), -5.2098523); r != -5.2098523 || err != nil {
		t.Fatal("TestDouble(-5.2098523) failed")
	}
	if r, err := client.TestDouble(context.Background(), -7.012052175215044); r != -7.012052175215044 || err != nil {
	...
	if r, err := client.TestStruct(context.Background(), out); !reflect.DeepEqual(r, out) || err != nil {
	...
	out2.I32Thing = 5
	if r, err := client.TestNest(context.Background(), out2); !reflect.DeepEqual(r, out2) || err != nil {
	...
	if r, err := client.TestMap(context.Background(), mapout); !reflect.DeepEqual(r, mapout) || err != nil {
	...
	if r, err := client.TestStringMap(context.Background(), mapTestInput); !reflect.DeepEqual(r, mapTestInput) || err != nil {
		t.Fatal("TestStringMap failed")
	}

	setTestInput := map[int32]bool{1: true, 2: true, 3: true}
	if r, err := client.TestSet(context.Background(), setTestInput); !reflect.DeepEqual(r, setTestInput) || err != nil {
		t.Fatal("TestSet failed")
	}

	listTest := []int32{1, 2, 3}
	if r, err := client.TestList(context.Background(), listTest); !reflect.DeepEqual(r, listTest) || err != nil {
		t.Fatal("TestList failed")
	}

	if r, err := client.TestEnum(context.Background(), thrifttest.Numberz_ONE); r != thrifttest.Numberz_ONE || err != nil {
		t.Fatal("TestEnum failed")
	}

	if r, err := client.TestTypedef(context.Background(), 69); r != 69 || err != nil {
	...
	if r, err := client.TestMapMap(context.Background(), 1); !reflect.DeepEqual(r, mapMapTest) || err != nil {
	...
	if r, err := client.TestInsanity(context.Background(), crazy); !reflect.DeepEqual(r, insanity) || err != nil {
		t.Fatal("TestInsanity failed")
	}

	if err := client.TestException(context.Background(), "TException"); err == nil {
		t.Fatal("TestException TException failed")
	}

	if err, ok := client.TestException(context.Background(), "Xception").(*thrifttest.Xception); ok == false || err == nil {
		t.Fatal("TestException Xception failed")
	} else if err.ErrorCode != 1001 || err.Message != "Xception" {
		t.Fatal("TestException Xception failed")
	}

	if err := client.TestException(context.Background(), "no Exception"); err != nil {
		t.Fatal("TestException no Exception failed")
	}

	if err := client.TestOneway(context.Background(), 0); err != nil {
