...
type ListValue struct {
	Values []*Value `thrift:"values,1,required" db:"values" json:"values"`
}
...
type MapEntry struct {
	Key   *Value `thrift:"key,1,required" db:"key" json:"key"`
	Value *Value `thrift:"value,2,required" db:"value" json:"value"`
}
...
type MapValue struct {
	Entries []*MapEntry `thrift:"entries,1,required" db:"entries" json:"entries"`
}
...
//   - StructValue
type Value struct {
	NullValue    *NullValue   `thrift:"null_value,1" db:"null_value" json:"null_value,omitempty"`
	...
	ListValue    *ListValue   `thrift:"list_value,7" db:"list_value" json:"list_value,omitempty"`
	MapValue     *MapValue    `thrift:"map_value,8" db:"map_value" json:"map_value,omitempty"`
	StructValue  *StructValue `thrift:"struct_value,9" db:"struct_value" json:"struct_value,omitempty"`
}
...
type StructValue struct {
	Fields map[string]*Value `thrift:"fields,1" db:"fields" json:"fields,omitempty"`
}
...
var StructValue_Fields_DEFAULT map[string]*Value
...
func (p *StructValue) IsSetFields() bool {
	return p.Fields != nil
}
