...
module Types
  module Type_definition
    ...
    class ListTypeDefinition
      ...
      FIELDS = {
        THRIFT_FIELD_INDEX_ELEMENT_TYPE => {type: ::Thrift::Types::STRUCT, name: 'element_type', class: ::Types::Type_definition::TypeDefinition, legacy_annotations: THRIFT_FIELD_ELEMENT_TYPE_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_ELEMENT_TYPE_STRUCTURED_ANNOTATIONS}
      }.freeze
    ...
    class MapTypeDefinition
      ...
      FIELDS = {
        THRIFT_FIELD_INDEX_KEY_TYPE => {type: ::Thrift::Types::STRUCT, name: 'key_type', class: ::Types::Type_definition::TypeDefinition, legacy_annotations: THRIFT_FIELD_KEY_TYPE_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_KEY_TYPE_STRUCTURED_ANNOTATIONS},
        THRIFT_FIELD_INDEX_VALUE_TYPE => {type: ::Thrift::Types::STRUCT, name: 'value_type', class: ::Types::Type_definition::TypeDefinition, legacy_annotations: THRIFT_FIELD_VALUE_TYPE_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_VALUE_TYPE_STRUCTURED_ANNOTATIONS}
      }.freeze
