...
require 'thrift'
require 'types/constant_definition/constant_definition_types'
require 'types/enum_definition/enum_definition_types'
require 'types/type_definition/type_definition_types'
require 'types/struct_definition/struct_definition_types'
require 'types/service_definition/service_definition_types'
  ...
  module Program_definition
    ...
    class ProgramDefinition
      ...
      FIELDS = {
        ...
        THRIFT_FIELD_INDEX_INCLUDES => {type: ::Thrift::Types::LIST, name: 'includes', element: {type: ::Thrift::Types::STRUCT, class: ::Types::Program_definition::ProgramDefinition}, legacy_annotations: THRIFT_FIELD_INCLUDES_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_INCLUDES_STRUCTURED_ANNOTATIONS},
        THRIFT_FIELD_INDEX_STRUCTS => {type: ::Thrift::Types::MAP, name: 'structs', key: {type: ::Thrift::Types::STRING}, value: {type: ::Thrift::Types::STRUCT, class: ::Types::Struct_definition::StructDefinition}, legacy_annotations: THRIFT_FIELD_STRUCTS_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_STRUCTS_STRUCTURED_ANNOTATIONS},
        THRIFT_FIELD_INDEX_SERVICES => {type: ::Thrift::Types::MAP, name: 'services', key: {type: ::Thrift::Types::STRING}, value: {type: ::Thrift::Types::STRUCT, class: ::Types::Service_definition::ServiceDefinition}, legacy_annotations: THRIFT_FIELD_SERVICES_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_SERVICES_STRUCTURED_ANNOTATIONS},
        THRIFT_FIELD_INDEX_CONSTANTS => {type: ::Thrift::Types::MAP, name: 'constants', key: {type: ::Thrift::Types::STRING}, value: {type: ::Thrift::Types::STRUCT, class: ::Types::Constant_definition::ConstantDefinition}, legacy_annotations: THRIFT_FIELD_CONSTANTS_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_CONSTANTS_STRUCTURED_ANNOTATIONS},
        THRIFT_FIELD_INDEX_TYPEDEFS => {type: ::Thrift::Types::MAP, name: 'typedefs', key: {type: ::Thrift::Types::STRING}, value: {type: ::Thrift::Types::STRUCT, class: ::Types::Type_definition::TypeDefinition}, legacy_annotations: THRIFT_FIELD_TYPEDEFS_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_TYPEDEFS_STRUCTURED_ANNOTATIONS},
        THRIFT_FIELD_INDEX_ENUMS => {type: ::Thrift::Types::MAP, name: 'enums', key: {type: ::Thrift::Types::STRING}, value: {type: ::Thrift::Types::STRUCT, class: ::Types::Enum_definition::EnumDefinition}, legacy_annotations: THRIFT_FIELD_ENUMS_LEGACY_ANNOTATIONS, structured_annotations: THRIFT_FIELD_ENUMS_STRUCTURED_ANNOTATIONS}
      }.freeze
