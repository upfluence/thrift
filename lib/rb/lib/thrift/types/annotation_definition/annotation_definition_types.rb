...
module Thrift
  module Types
    module Annotation_definition
      class StructuredAnnotation; end
      ...
      class StructuredAnnotation
        ...
        NAME = 'StructuredAnnotation'.freeze
