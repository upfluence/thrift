...
void ProgramDefinition::__set_constants(const std::map<std::string,  ::types::value::ValueDefinition> & val) {
  this->constants = val;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i30 = 0; _i30 < _size26; ++_i30)
            {
              ...
              xfer += iprot->readString(_key31);
               ::types::value::ValueDefinition& _val32 = this->constants[_key31];
...
uint32_t ProgramDefinition::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("constants", ::apache::thrift::protocol::T_MAP, 8);
  {
    ...
    std::map<std::string,  ::types::value::ValueDefinition> ::const_iterator _iter51;
