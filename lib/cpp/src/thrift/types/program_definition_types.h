...
class ProgramDefinition : public virtual ::apache::thrift::TBase {
 public:
  ...
  std::map<std::string,  ::types::value_definition::ValueDefinition>  constants;
  ...
  void __set_constants(const std::map<std::string,  ::types::value_definition::ValueDefinition> & val);
